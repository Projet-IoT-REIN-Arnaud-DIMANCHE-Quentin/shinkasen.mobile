...
export const DeviceActions: React.FC<Props> = ({
    ...
    const renderMap = () => {
        ...
        const mapProps = {
            ...
            markers: [{
                coordinates: { latitude: gpsPosition.latitude, longitude: gpsPosition.longitude },
            ...
            {/* Section config */}
            {
                currentConfig && (
                    <View style={{
                        ...
                        <Text>Dernière transmission: {new Date(currentConfig.lastTransmission).toLocaleString()}</Text>
                    </View>
                )
            }

            <View className="flex-col space-y-4 mt-4">
                {/* Ligne 1: Toggle ON/OFF avec label */}
                ...
                {/* Ligne 2: Input et Valider avec label */}
                <View className="flex-col space-y-2">
                    <Text style={{ fontWeight: '600', fontSize: 14, color: 'white' }}>
